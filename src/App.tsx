          ...
          <AnimatePresence mode="wait">
            {step === 'identity' && (
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em]">Section 01: Verify Recipient</p>
                </div>
            ...
            {step === 'payment' && (
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em]">Section 02: Payment</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-[10px] font-bold text-[#0070ba] uppercase">Instant</p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div className="text-left">
                        <p className="text-sm font-black text-white uppercase tracking-widest">Credit Card</p>
                        <p className="text-[10px] font-bold text-text-muted uppercase italic">Safe Payment</p>
                      </div>
                    </div>
            ...
            {step === 'paypal_details' && (
              ...
              >
                ...
                <p className="text-[9px] font-bold text-center text-text-muted uppercase tracking-widest opacity-50">
                  Redirecting to extra verification...
                </p>
              </motion.div>
            )}
            ...
            {step === 'delivery_processing' && (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em]">Finalizing Delivery</p>
                </div>
            ...
            {step === 'success' && (
              ...
              >
                ...
                <div className="space-y-3">
                  <h2 className="text-4xl font-black text-white italic uppercase tracking-tighter">Order Successful</h2>
                  <p className="text-[11px] font-black text-green-500 uppercase tracking-[0.3em]">Gift Sent to @{profile?.username}</p>
                </div>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-6 text-left space-y-4">
                  ...
                  <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-primary">
                    ...
                    <span className="font-black italic">2-3 HOURS</span>
                  </div>
                </div>
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-[#121215] border border-white/10 rounded-3xl p-8 space-y-6 shadow-2xl">
          <div className="text-center space-y-2">
            <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter">Admin Panel</h2>
            <p className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em]">Secure Login</p>
          </div>
      ...
      >
        <div className="bg-[#121215] border border-white/5 rounded-[2.5rem] p-10 shadow-[0_0_100px_rgba(0,0,0,0.8)] space-y-8 relative">
          ...
          <div className="text-center space-y-2 pt-6">
            ...
            <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.3em]">Web Access Key Required</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[9px] font-black text-text-muted uppercase tracking-[0.2em] ml-2">License Key</label>
          ...
          <p className="text-[10px] font-black text-text-muted uppercase tracking-widest">
            By entering a license key you agree to our automated security protocols. unauthorized attempts are logged.
          </p>
        </div>
